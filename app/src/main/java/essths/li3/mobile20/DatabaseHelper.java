...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public boolean insertUser(String username, String email, String phone, String password) {
        ...
        String query = "INSERT INTO " + TABLE_NAME + "(" + COLUMN_USERNAME + ", " + COLUMN_EMAIL + ", " + COLUMN_PHONE + ", " + COLUMN_PASSWORD + ") VALUES(?, ?, ?, ?)";
        db.execSQL(query, new Object[]{username, email, phone, password});
        return true;
    }
